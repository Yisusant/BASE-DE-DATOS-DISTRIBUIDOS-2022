...
from Curso as cu, curso_has_estudiante as PROFESORES
...
create view No_Aprobados_Semestres as 
...
select idProfesor, count(idProfesor)*100/5 as REPROBADOS_POR
from noaprobadosSemestres 
group by idProfesor; 

select idProfesor,Max(REPROBADOS_POR)
...
select idMateria, grupo, count(idMateria)*100/5 as REPROBADOS_POR
